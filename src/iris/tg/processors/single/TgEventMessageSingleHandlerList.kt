 ...
 */
class TgEventMessageSingleHandlerList<M : Message
	, IQ : InlineQuery
	...
	, CJR: ChatJoinRequest
>(val list: List<TgEventMessageSingleHandler<M, IQ, CIR, CQ, SQ, PCQ, P, PA, CMU, CJR>>) : TgEventMessageSingleHandler<M, IQ, CIR, CQ, SQ, PCQ, P, PA, CMU, CJR> {
