 ...
 */
class TgEventMessagePackHandlerList<M : Message
	, IQ : InlineQuery
	...
	, CJR: ChatJoinRequest
>(val list: List<TgEventMessagePackHandler<M, IQ, CIR, CQ, SQ, PCQ, P, PA, CMU, CJR>>) : TgEventMessagePackHandler<M, IQ, CIR, CQ, SQ, PCQ, P, PA, CMU, CJR> {
