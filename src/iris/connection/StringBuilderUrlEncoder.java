 ...
 * @since   1.0
 */
public class StringBuilderUrlEncoder {
     ...
     */
    private StringBuilderUrlEncoder() { }
     ...
     * @since 1.4
     */
    public static void encode(StringBuilder out, String s, String enc)
        throws UnsupportedEncodingException {
        if (enc == null) {
     ...
     * @since 10
     */
    public static void encode(StringBuilder out, String s, Charset charset) {
